...
run:
	java Juego Pikinim Cyan Magenta Amarillo Zona Pieza Enemigo Pildora Muralla ILevantar

clean:
	rm -f Pikinim.class Cyan.class Magenta.class Amarillo.class Zona.class Pieza.class Enemigo.class Pildora.class Muralla.class Juego.class ILevantar.class
